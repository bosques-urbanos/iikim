...
def build_argparser():
    ...
    args.add_argument('-id', '--identification', default="Camera1", type=str,
                        help="Camera Identification")
    args.add_argument('-sfps', '--sink_fps', default="30", type=int,
                        help="Sink Framerate")
    args.add_argument('-sfcc', '--sink_fourcc', default="XVID", type=str,
                        help="Sink FOURCC")
    args.add_argument('-shi', '--sink_ip', default="172.17.0.1", type=str,
                        help="Sink Host IP")
    args.add_argument('-shp', '--sink_port', default=5001, type=int,
                        help="Sink Host Port")
